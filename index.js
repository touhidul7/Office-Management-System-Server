...
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:5174', 'https://britto-oms.vercel.app', 'http://192.168.1.2:5173', 'https://britto-oms.netlify.app', 'https://office-management-system-frontend.vercel.app'],
  credentials: true,
}))
